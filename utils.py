...
def get_transformed_position(file_name):
    """
    ...
    ts_base2eb = keypoint_transform(T_w2base, T_w2eb)
    ts_base2wr = keypoint_transform(T_w2base, T_w2wr)
    ts_base2ee = keypoint_transform(T_w2base, T_w2ee)
